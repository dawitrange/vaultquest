...
11. In-memory CPX replay uses the real handler to prove OfferClick claim + `credited=true` + one PENDING ledger row, including simultaneous same-transaction callbacks.
